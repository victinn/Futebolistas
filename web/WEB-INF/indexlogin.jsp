    ...
    <div class="side-menu">
      <div class="modal-logado" id="modal-logado">
        <div class="content-logado">
          ...
          <div id=modal-titulo>${u.getNome()}</div> <!--AQ É A VARIÁVEL DO NOME QUE O USUÁRIO ESCOLHEU -->
          ...
          <div id="modal-line"></div>
          <div id="option"><center><a href="UsuarioRemover?id=${u.getId()}">Apagar conta</a></center></div>
          <div id="modal-line"></div>
